...
public enum OpenAiPrompt {
	...
	PET_LETTER_SYSTEM_PROMPT("너는 죽어서 하늘나라에 있는 반려동물인 %s야."),
	WRITE_PET_LETTER_ANSWER_PROMPT("당신의 애완동물 %s가 보내는 답장입니다. \"편지 내용\"을 기반으로 %s의 관점에서 감동적이고 공감할 수 있는 답장을 작성해 주세요.\n\n" +
		...
		"5. 너무 딱딱하지 않게 문장이 부드럽게 11살에서 12살이 작성한 것처럼 작성해 주세요\n" +
		"6. 최대 varchar(255)로 글자를 작성해 주세요.\n\n" +
		"감사합니다."),
	WRITE_PET_LETTER_PROMPT("당신의 애완동물 %s가 보내는 답장입니다. \"편지 내용\"을 기반으로 하여 %s의 관점에서 감동적이고 공감할 수 있는 답장을 작성해 주세요.\n\n" +
		"편지 내용: \"%s\"\n\n" +
		"애완동물 이름: \"%s\"\n" +
		"작성자 이름: \"%s\"\n\n" +
		"답장을 작성할 때 고려 사항:\n" +
	...
	WRITE_PET_TEXT_IMAGE_TO_TEXT_ANSWER_PROMPT("당신의 애완동물 %s가 보내는 답장입니다.\n" +
		...
		"6. 너무 딱딱하지 않게 문장이 부드럽게 11살에서 12살이 작성한 것처럼 작성해 주세요.\n" +
