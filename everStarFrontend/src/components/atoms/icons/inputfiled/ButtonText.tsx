  ...
  return (
    ...
    >
      ...
      {color === "black" && showIcon && (
        <svg
          className={["large", "medium"].includes(size) ? "!relative !w-6 !h-6" : size === "small" ? "!relative !w-4 !h-4" : undefined}
          width="24"
          height="24"
          viewBox="0 0 24 24"
          fill="none"
