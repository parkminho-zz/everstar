...
const milestoneColors = [
  { min: 0, max: 6, color: "bg-pink-300" },
  { min: 7, max: 13, color: "bg-red-500" },
  { min: 14, max: 20, color: "bg-orange-500" },
  { min: 21, max: 27, color: "bg-yellow-400" },
  { min: 28, max: 34, color: "bg-green-500" },
  { min: 35, max: 41, color: "bg-blue-500" },
  { min: 42, max: 48, color: "bg-indigo-600" },
  { min: 49, max: 49, color: "bg-purple-600" },
];
