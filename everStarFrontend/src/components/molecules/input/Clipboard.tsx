...
export const Clipboard = ({ status, className }: ClipboardProps): JSX.Element => {
  return (
    <div className={`w-80 flex flex-col items-center gap-2 shadow-[0px_4px_8px_#dbe5ec99,0px_0px_1px_1px_#dbe5ec99] px-4 py-2 h-14 overflow-hidden rounded-xl justify-center bg-white relative ${className}`}>
