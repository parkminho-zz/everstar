...
import { ButtonText, ButtonTextProps,  } from "../../atoms/icons/inputfiled/ButtonText";
...
export const Placeholder = ({ showLeftIcon = true, state, className, ...ButtonTextProps }: PlaceholderProps): JSX.Element => {
  return (
